...
namespace CompanyAndLibrary.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Projects.Include(p => p.Department);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DepartmentId")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DepartmentId")] Project project)
        {
            if (id != project.Id)
            {
                return NotFound();
